 ...
 * });
 */
export function useGetMyTodosQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetMyTodosQuery, GetMyTodosQueryVariables>(
    GetMyTodosDocument,
    options
  );
}
export function useGetMyTodosLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetMyTodosQuery, GetMyTodosQueryVariables>(
    GetMyTodosDocument,
    options
  );
}
export type GetMyTodosQueryHookResult = ReturnType<typeof useGetMyTodosQuery>;
export type GetMyTodosLazyQueryHookResult = ReturnType<
  typeof useGetMyTodosLazyQuery
>;
export type GetMyTodosQueryResult = Apollo.QueryResult<
  GetMyTodosQuery,
  GetMyTodosQueryVariables
>;
